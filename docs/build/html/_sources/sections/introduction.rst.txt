Structure Based Models (SBMs) are representations of protein systems based on simplifications made over classical Molecular Dynamics (MD) force fields. Their are based on the energy landscape theory of protein folding and the principal of minimal frustration. The models maintain protein structures by focusing only on the chemical contacts formed at the native protein configuration, ignoring all other contacts. This allows for simpler force field definitions which capture essential protein dynamics at a much lower computational expense than traditional MD simulations. 
